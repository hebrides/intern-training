...
_Stongly consider_ using a [no code / low code](https://youtu.be/jaRCENYBuYo) [platform](https://www.makerpad.co) or [form builder](https://www.techradar.com/best/best-online-form-builder) to rapidly prototype your application before coding. This will help you discover and fix UI hiccups early on. Programming, being labor intensive and requiring post-debugging and QA, normally comes [after](https://orionadvisortech.com/wp-content/uploads/2019/11/Screen-Shot-2019-11-04-at-1.13.10-PM.png) design in the software development life cycle ([SDLC](https://theproductmanager.com/topics/software-development-life-cycle/)). You may be able to implement a workable solution [without little to no coding at all](https://youtu.be/-_xKI3GJpMM), freeing you and your business to expend efforts on other pursuits.
