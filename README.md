...
3) Docker (set up “containers“ - OSs and programs running inside their own little [VM-like processes](https://stackoverflow.com/questions/16047306/how-is-docker-different-from-a-virtual-machine?rq=1)): https://hub.docker.com/search?q=kali&type=image ; https://kubernetes.io/docs/concepts/containers/
