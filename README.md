...
1) Writing scripts to set up virtual machines (VMs) with the operating systems, databases and programs you want pre-installed and configured. This is sometimes called [Infrastructure as Code](https://youtu.be/KxxRl6VEBxI) (IaC). 
