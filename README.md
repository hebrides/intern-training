...
There are [many programs](https://digital.ai/periodic-table-of-devops-tools) in the market that help tie together and manage devops infrastructures with GUI systems and [YAML](https://www.linkedin.com/pulse/learn-yaml-devops-easy-way-sandip-das/)-inspired scripts. Learn what meets your needs. E.g., after you finish your first simple client-server-database app, write a `docker-compose` script that builds the app's infrastructure in steps as separate containers linked and hosted on your local machine. Then use [K3s](https://github.com/k3s-io/k3s/blob/master/README.md) to simulate locally how your app will be [orchestrated](https://stackoverflow.com/questions/58638003/helm-charts-vs-ansible-playbook-vs-k8s-operator-in-system-installation#59317880) and managed on a "[cloud](https://pocketnow.com/no-such-thing-as-the-cloud)" host.

You may be thinking this is quite a lot of ceremony for a web app. Do you really need to master advanced DevOps pipelining and orchestration tools to become an _amazing web developer_? It depends on where you may work, or what you may want to do. You should learn the problems DevOps tools solve in general now, then acquire implementation details for your use case when it's necessary. For example, what problems does a multinode manager like Kubernetes (or [Titus](https://github.com/netflix)) solve? [Big ones, mostly](https://kubernetes.io/case-studies/cern/). Maybe you're building your own cloud service that needs hundreds of nodes to support your customers. Or an AI tool that runs on thousands of nodes, and you want to use a large cloud vendor's machines with precision and thrift as demand scales. [A media streaming service like Netflix](https://github.com/Netflix) allows millions of users to watch 4K videos on demand, and so has big server and infrastructure requirements. As you can see, it's scale that determines needs. A simple web app can do just fine on a single node VPS host; but bigger problems require more complex solutions.
