...
[A media streaming service like Netflix](https://github.com/Netflix), e.g., must utilize DevOps tools, because of the amount of data and bandwidth the service provides: Millions of users watch 4K videos on demand using Netflix. The company can ill afford downtime. They will always need skilled DevOps engineers.
